    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          vector<double> ptsx = j[1]["ptsx"];   // Global x positions of waypoints
          vector<double> ptsy = j[1]["ptsy"];   // Global y positions of waypoints
          ...
          */
           // Convert waypoints to the vehicle coordinate
           //https://discussions.udacity.com/t/coordinate-system-car-being-at-0-0/322984
          ...
          auto coeffs = polyfit(ptsx_transform, ptsy_transform, 3);
					//calculate current cte and epsi
...
//				state << 0, 0, 0, v, cte, epsi;
          ...
          for (std::size_t i = 2; i < vars.size(); i ++) {
            if (i%2 == 0) {
