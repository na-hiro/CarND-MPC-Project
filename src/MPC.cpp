 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    // the Solver function below.
		...
		// Cost calculation
		//***************************
    // Based on the setting of the following URL,
    // it was changed to the setting corresponding to the high-speed curve.
    // It was confirmed that it does not deviate from the lane even for long-term driving for several hours.
    // https://www.youtube.com/watch?v=bOQuhpz3YfU&list=PLAwxTw4SYaPnfR7TzRZN-uxlxGbqxhtm2&index=5.

		// The part of the cost based on the reference state.
		for (t = 0; t < N; t++) {
      // The setting where center deviation in the curve is allowed.
      // It enables curves at high speed.
			fg[0] += 1000/*1000*/ * CppAD::pow(vars[cte_start + t]  - ref_cte, 2);
			fg[0] += 1500/*1500*/ * CppAD::pow(vars[epsi_start + t] - ref_epsi, 2);
